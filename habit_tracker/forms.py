...
class CreateTaskForm(forms.Form):
    task = forms.CharField(max_length=30, widget=forms.TextInput(attrs={'class': 'create_task_input'}))
    notes = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'create_notes_input'}))
